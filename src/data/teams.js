// Team logos stored locally in /public/images/teams/
// Football club logos: Premier League resource CDN + Wikipedia
// National teams: Wikipedia flag icons
// Hockey: Wikipedia logos
...
export const ALL_TEAMS = Object.entries(TEAMS).flatMap(([sport, { teams }]) =>
  teams.map((t) => ({ ...t, sport }))
)
