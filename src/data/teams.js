    ...
    sections: [
      {
        ...
        teams: [
          { id: 'nt-sweden', name: 'Sweden', logo: 'https://flagcdn.com/w80/se.png' },
          { id: 'nt-england', name: 'England', logo: 'https://flagcdn.com/w80/gb-eng.png' },
          { id: 'nt-germany', name: 'Germany', logo: 'https://flagcdn.com/w80/de.png' },
          { id: 'nt-france', name: 'France', logo: 'https://flagcdn.com/w80/fr.png' },
          { id: 'nt-spain', name: 'Spain', logo: 'https://flagcdn.com/w80/es.png' },
          { id: 'nt-italy', name: 'Italy', logo: 'https://flagcdn.com/w80/it.png' },
          { id: 'nt-netherlands', name: 'Netherlands', logo: 'https://flagcdn.com/w80/nl.png' },
          { id: 'nt-portugal', name: 'Portugal', logo: 'https://flagcdn.com/w80/pt.png' },
          { id: 'nt-brazil', name: 'Brazil', logo: 'https://flagcdn.com/w80/br.png' },
          { id: 'nt-argentina', name: 'Argentina', logo: 'https://flagcdn.com/w80/ar.png' },
          { id: 'nt-norway', name: 'Norway', logo: 'https://flagcdn.com/w80/no.png' },
          { id: 'nt-denmark', name: 'Denmark', logo: 'https://flagcdn.com/w80/dk.png' },
        ],
      },
      {
        title: 'Clubs',
    ...
    sections: [
      {
        title: 'National Teams',
        teams: [
          { id: 'nt-hockey-sweden', name: 'Sweden', logo: 'https://flagcdn.com/w80/se.png' },
          { id: 'nt-hockey-finland', name: 'Finland', logo: 'https://flagcdn.com/w80/fi.png' },
          { id: 'nt-hockey-canada', name: 'Canada', logo: 'https://flagcdn.com/w80/ca.png' },
          { id: 'nt-hockey-usa', name: 'USA', logo: 'https://flagcdn.com/w80/us.png' },
          { id: 'nt-hockey-czech', name: 'Czech Republic', logo: 'https://flagcdn.com/w80/cz.png' },
          { id: 'nt-hockey-russia', name: 'Russia', logo: 'https://flagcdn.com/w80/ru.png' },
        ],
      },
      {
        title: 'SHL',
